...
import static com.workshare.msnos.integration.IntegrationTestFrame.CommandPayload.Command.AGENT_JOIN;
import static com.workshare.msnos.integration.IntegrationTestFrame.CommandPayload.Command.AGENT_LEAVE;
import static com.workshare.msnos.integration.IntegrationTestFrame.CommandPayload.Command.SELF_KILL;
...
import com.workshare.msnos.integration.IntegrationTestFrame.CommandPayload.Command;

public class CoreIT implements IntegrationTestFrame {
    ...
    @Test
    public void shouldSeeRemoteJoining() throws Exception {
        sendCommand(AGENT_JOIN);
        assertCondition(ONE_AGENT_IN_CLOUD);
    }

    @Test
    public void shouldUnseeRemoteLeaving() throws Exception {
        sendCommand(AGENT_JOIN);
        assertCondition(ONE_AGENT_IN_CLOUD);
    ...
    @Test
    public void shouldUnseeRemoteDying() throws Exception {
        sendCommand(AGENT_JOIN);
        assertCondition(ONE_AGENT_IN_CLOUD);
