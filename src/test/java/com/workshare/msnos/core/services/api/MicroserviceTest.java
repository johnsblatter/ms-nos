...
import com.workshare.msnos.core.services.api.MicroservicesHub;
...
public class MicroserviceTest {
    ...
    private LocalMicroservice localMicroservice;
    ...
    public void prepare() throws Exception {
        ...
        localMicroservice = new LocalMicroservice("fluffy");
    ...
    public void shouldInternalAgentJoinTheCloudOnJoin() throws Exception {
        localMicroservice = new LocalMicroservice("jeff");
    ...
    public void shouldInternalAgentLeaveTheCloudOnLeave() throws Exception {
        ...
        final MicroservicesHub ucloud = newMicrocloud(cloud);
    ...
    public void shouldNotBoomWhenLeavingCloduWhenNotjoinedBefore() throws Exception {
        Mockito.reset(cloud);
        LocalMicroservice ms = new LocalMicroservice("temp");
        ms.leave();
    ...
    private MicroservicesHub newMicrocloud(Cloud cloud) {
        return new MicroservicesHub(cloud, mock(ScheduledExecutorService.class));
    }
